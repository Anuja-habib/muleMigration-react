...
const XsdToRaml = () => {
    ...
    let subtitle =
        'To use the tool, simply upload your XSD file and click the "Convert" button. The tool will then generate a RAML file that you can download and use to create APIs.';
