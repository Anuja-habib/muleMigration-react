...
const RAMLExampleGenerator = () => {
  ...
  `}
      ...
      ${isLoading ? 'bg-gray-400 cursor-not-allowed' : 'bg-teal-600 hover:bg-teal-800 hover:translate-y-[-1px] hover:shadow-[0_4px_8px_rgba(74,70,204,0.3)] text-white'}`}
            ...
            <div className="flex items-center justify-between py-4 px-5 bg-white border-b border-[#e1e4e8]">
              ...
              <div className="flex items-center gap-4 h-full">
                ...
                <button
                  ...
                  onClick={() => handleDownload(outputContent, filename)} // Use filename from input
                >
