    ...
    return (
        <div style={{ display: 'flex' }}>
            <div style={{ width: '300px', borderRight: '1px solid #ccc', padding: '10px' }}>
                <FileExplorer fileStructure={fileStructure.root} onFileClick={handleFileClick} mainFolderName={mainFolderName}  />
            </div>
...
export const FileExplorer = ({ fileStructure, onFileClick }) => {
            ...
            if (typeof content === 'string') {
                ...
                return (
                    <div className='fileNames'
                        ...
                        style={{ paddingLeft: `${path.length * 20}px`, cursor: 'pointer', display: 'flex', alignItems: 'center' }}
    ...
    return (
        <div className="file-explorer">
            <button onClick={downloadZip} style={{ marginBottom: '10px', display: 'flex', alignItems: 'center' }}>
