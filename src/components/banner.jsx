  ...
  return (
    <BannerContainer>
      ...
      <BannerContent>
        ...
        <BannerText>
          Save time and reduce complexity with our purpose-built accelerators to build faster, migrate smarter, deliver sooner
        </BannerText>
      </BannerContent>
    </BannerContainer>
  );
...
export const SmallBanner = ({ title, subtitle }) => {
  return (
    <BannerContainer style={{ height: '140px' }}>
      <BackgroundGraphics />
      <BannerContent style={{ left: '0', width: '100%', textAlign: 'center', alignItems: 'center', padding: '0 24px' }}>
