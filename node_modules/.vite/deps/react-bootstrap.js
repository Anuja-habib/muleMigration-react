...
import {
  ...
  useBootstrapPrefix,
  useIsRTL
} from "./chunk-XF6CMFHS.js";
import {
  ENTERED,
  ENTERING,
  EXITED,
  EXITING
} from "./chunk-MKYZH7U2.js";
import {
  require_prop_types
...
function forEach(children, func) {
  ...
  React19.Children.forEach(children, (child) => {
    if (React19.isValidElement(child)) func(child, index++);
  });
}
...
var Feedback = React45.forwardRef(
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  ({
    as: Component2 = "div",
    className,
...
var FormCheckInput = React47.forwardRef(({
  id,
  bsPrefix,
  className,
  type = "checkbox",
...
var FormCheckLabel = React48.forwardRef(({
  bsPrefix,
  className,
  htmlFor,
  ...props
...
var FormCheck = React49.forwardRef(({
  id,
  bsPrefix,
  bsSwitchPrefix,
  inline = false,
...
var FormFloating = React51.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var FormGroup = React52.forwardRef(({
  controlId,
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  as: Component2 = "div",
  ...props
...
var FormRange = React54.forwardRef(({
  bsPrefix,
  className,
  id,
  ...props
...
var FormSelect = React55.forwardRef(({
  bsPrefix,
  size: size2,
  htmlSize,
  className,
...
var FormText = React56.forwardRef(
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  ({
    bsPrefix,
    className,
...
var Switch = React57.forwardRef((props, ref) => (0, import_jsx_runtime52.jsx)(FormCheck_default, {
  ...props,
  ref,
  type: "switch"
}));
...
var FloatingLabel = React58.forwardRef(({
  bsPrefix,
  className,
  children,
  controlId,
...
var InputGroupText = React60.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "span",
  ...props
...
var Modal2 = React77.forwardRef(({
  ...
  const renderBackdrop = (0, import_react50.useCallback)((backdropProps) => (0, import_jsx_runtime72.jsx)("div", {
    ...backdropProps,
...
var Offcanvas = React88.forwardRef(({
  ...
  const renderBackdrop = (0, import_react56.useCallback)((backdropProps) => (0, import_jsx_runtime83.jsx)("div", {
    ...backdropProps,
...
var NavbarOffcanvas = React89.forwardRef(({
  onHide,
  ...props
}, ref) => {
...
var OverlayTrigger = ({
  ...
  return (0, import_jsx_runtime100.jsxs)(import_jsx_runtime99.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react63.cloneElement)(children, triggerProps), (0, import_jsx_runtime98.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip: flip2,
...
function createButton(name, defaultValue, label = name) {
  const Button2 = React101.forwardRef(({
    children,
    ...props
...
var ToastFade = React118.forwardRef((props, ref) => (0, import_jsx_runtime121.jsx)(Fade_default, {
  ...props,
  ref,
